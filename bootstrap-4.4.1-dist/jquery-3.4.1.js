...
!(function(e, t) {
            ...
            : function(e, t, n) {
                ...
                if (c) {
                  ...
                  if (((u = [m ? c.firstChild : c.lastChild]), m && p)) {
                    ...
                    (p && (d = s = (r = (i = (o = (a = e)[k] || (a[k] = {}))[a.uniqueID] || (o[a.uniqueID] = {}))[h] || [])[0] === S && r[1]),
                    !1 === d)
                  )
                    while ((a = (++s && a && a[l]) || (d = s = 0) || u.pop()))
                      if (
  ...
  (Y.uid = 1),
    (Y.prototype = {
      cache: function(e) {
        ...
        return (
          t || ((t = {}), G(e) && (e.nodeType ? (e[this.expando] = t) : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))), t
        );
      },
      set: function(e, t, n) {
        var r,
  ...
  k.extend({
    ...
    k.extend({
      queue: function(e, t, n) {
        ...
        if (e)
          return (
            (t = (t || "fx") + "queue"), (r = Q.get(e, t)), n && (!r || Array.isArray(n) ? (r = Q.access(e, t, k.makeArray(n))) : r.push(n)), r || []
          );
      },
        ...
        k.event.add(e, i, {
          ...
          handler: function(e) {
            ...
            if (1 & e.isTrigger && this[i]) {
              ...
              r.length &&
                (Q.set(this, i, { value: k.event.trigger(k.extend(r[0], k.Event.prototype), r.slice(1), this) }), e.stopImmediatePropagation());
          }
        }))
  ...
  (k.Animation = k.extend(dt, {
    ...
    (k.speed = function(e, t, n) {
      var r =
        e && "object" == typeof e ? k.extend({}, e) : { complete: n || (!n && t) || (m(e) && e), duration: e, easing: (n && t) || (t && !m(t) && t) };
      return (
        k.fx.off
          ? (r.duration = 0)
        ...
        ? ((i = m(n)),
          this.each(function(e) {
            ...
            1 === this.nodeType &&
              ...
              ((r = k.valHooks[this.type] || k.valHooks[this.nodeName.toLowerCase()]) && "set" in r && void 0 !== r.set(this, t, "value")) ||
                (this.value = t));
          }))
        : t
      ...
      ajax: function(e, t) {
        ...
        function l(e, t, n, r) {
          ...
          h ||
            ...
            i
              ? (v.ifModified &&
                  ((u = T.getResponseHeader("Last-Modified")) && (k.lastModified[f] = u), (u = T.getResponseHeader("etag")) && (k.etag[f] = u)),
                204 === e || "HEAD" === v.type
                  ? (l = "nocontent")
                  : 304 === e
                  ? (l = "notmodified")
  ...
  k.ajaxSetup({
    ...
    (y.createHTMLDocument =
      (((Vt = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Vt.childNodes.length)),
